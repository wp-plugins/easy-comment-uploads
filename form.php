...
<form target="hiddenframe" enctype="multipart/form-data" action="' . $plugin_dir . 'upload.php" method="POST" name="uploadform" id="uploadform">
<p>
  Attach File:
  <input type="file" name="filefieldname" id="fileField"   onchange="uploadSubmit()" />
  </label>
</p>
<p id="uploadedfile" >
  <label></label>
