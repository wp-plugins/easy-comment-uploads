...
<h3 style="clear: both"><?php _e('Upload files') ?>:</h3>
<p style="margin-top: 4px"><?php _e('You can include images or files in your comment by selecting them below. Once you select a file, it will be uploaded and a link to it added to your comment. You can upload as many images or files as you like and they will all be added to your comment.') ?></p>
...
<!-- End of Easy Comment Uploads code -->
