...
*/
//echo "testAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
...
function comment_upload_form(){
    ...
    echo ("
        ...
        <br />
        Selecione o arquivo desejado em sua maquina, clique em Upload.<br/>
        Após a cópia para o servidor, clique no link que irá aparecer. Isso irá copiar um link para 
        a caixa de comentário, não apague-o.
